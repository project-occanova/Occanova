    ...
    <main id="main" className="container page-main">
      ...
      <div className="directory-layout">
        <aside className="filters">
          ...
          <SearchForm compact categories={s.categories} locations={s.locations} category={p.category} city={p.city} q={p.q}/>
          <p className="quiet-note">Featured vendors appear first, followed by vendors in alphabetical order.</p>
        </aside>
        <section>
