...
export default async function Review({params}:{params:Promise<{id:string}>}){
 ...
 return <Workspace admin email={user.email}>
  ...
  <div className="two-panels workspace-section-grid">
   ...
   <section className="panel workspace-section"><div className="workspace-section-heading"><div><h2>Account access</h2><p>Deactivate or restore the vendor account with an audited reason.</p></div></div><AdminLifecycleForm vendor={v}/></section>
  </div>
 </Workspace>;
}
